...
const Result = () => {
  ...
  return (
    <section id="results" className="relative z-10" ref={sectionRef}>
      <section
        id="why-us-section"
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className={`mt-1 mb-10 sm:mb-16 text-base/relaxed sm:text-lg/relaxed font-display font-normal text-gray-600 max-w-3xl mx-auto px-4 transition-opacity duration-700 ${sectionInView ? 'opacity-100' : 'opacity-0'}`}>
